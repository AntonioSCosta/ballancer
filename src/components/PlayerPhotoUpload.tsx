  ...
  return <div>
      ...
      <div className="flex flex-col items-center gap-4">
        ...
        <div className="flex gap-2">
          ...
          {(hasPhoto || previewUrl) && <Button type="button" variant="outline" size="sm" onClick={() => {
      ...
      <ImageCropDialog open={showCropDialog} onOpenChange={setShowCropDialog} imageUrl={rawImageUrl || ""} onSave={handleCroppedImageSave} />
    </div>;
};
